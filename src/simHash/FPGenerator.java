...
public final class FPGenerator {
	...
	/**
	 * Extends <code>f</code> with lower sixteen bits of <code>v</code>. Does
	 * not reduce.
	 */
	...
	/**
	 * Array of irreducible polynomials. For each degree <code>d</code> between
	 * 1 and 64 (inclusive), <code>polynomials[d][i]</code> is an irreducible
